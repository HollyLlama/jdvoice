...
function music_club_lite_customize_register( $wp_customize ) {	
	...
	$wp_customize->add_control('music_club_lite_header_contactem',array(	
		'type' => 'text',
		'label' => __('Add email address here','music-club-lite'),
		'section' => 'music_club_lite_hdr_contact_section',
		'setting' => 'music_club_lite_header_contactem'
	));	
	
	$wp_customize->add_setting('music_club_lite_show_header_contactem',array(
		'default' => false,
		'sanitize_callback' => 'music_club_lite_sanitize_checkbox',
		'capability' => 'edit_theme_options',
	));	 
	
	$wp_customize->add_control( 'music_club_lite_show_header_contactem', array(
	   'settings' => 'music_club_lite_show_header_contactem',
	   'section'   => 'music_club_lite_hdr_contact_section',
	   'label'     => __('Check To show This Section','music-club-lite'),
	   'type'      => 'checkbox'
...
?>
	<style type="text/css"> 					
		...
		textarea:focus,
		a:focus      
            { outline: thin dotted <?php echo esc_html( get_theme_mod('music_club_lite_color_scheme','#7643d2')); ?>;}			
