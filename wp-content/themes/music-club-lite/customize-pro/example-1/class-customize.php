 ...
 * @access public
 */
final class music_club_lite_Example_1_Customize {
	...
	public function music_club_lite_sections( $manager ) {
		...
		$manager->register_section_type( 'music_club_lite_Example_1_Customize_Section_Pro' );

		// Register sections.
		$manager->add_section(
			new music_club_lite_Example_1_Customize_Section_Pro(
				$manager,
				'example_1',
				array(
...
music_club_lite_Example_1_Customize::music_club_lite_get_instance();