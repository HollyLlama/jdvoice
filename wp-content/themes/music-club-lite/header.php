...
<?php esc_html_e( 'Skip to content', 'music-club-lite' ); ?>
</a>
<?php
...
$music_club_lite_show_header_contactem 	  			    = get_theme_mod('music_club_lite_show_header_contactem', false);
          ...
          <?php if( $music_club_lite_show_header_contactno != ''){ ?>      
               ...
               if( !empty($music_club_lite_header_contactno) ){ ?> 
                <div class="header-infobox">
                 <i class="fas fa-phone-square"></i><?php esc_html_e('Call: ','music-club-lite'); ?><?php echo esc_html($music_club_lite_header_contactno); ?>
                </div>
               <?php } ?>                           
           <?php } ?>

           <?php if( $music_club_lite_show_header_contactem != ''){ ?>      
               <?php 
               $music_club_lite_header_contactem = get_theme_mod('music_club_lite_header_contactem');
               if( !empty($music_club_lite_header_contactem) ){ ?> 
                <div class="header-infobox">
                 <i class="fas fa-envelope"></i><?php esc_html_e('Email: ','music-club-lite'); ?><?php echo esc_html($music_club_lite_header_contactem); ?>
                </div>
               <?php } ?>                           
           <?php } ?>
      ...
      <?php if( $music_club_lite_show_socialsection != ''){ ?> 
        <div class="social-icons">                                                
                  ...
                  <?php $music_club_lite_gplus_link = get_theme_mod('music_club_lite_gplus_link');
                    ...
                    <a title="instagram" class="fab fa-instagram" target="_blank" href="<?php echo esc_url($music_club_lite_gplus_link); ?>"></a>
                  <?php }?>
...
if( get_theme_mod('music_club_lite_servicescol'.$n,false)) {      
	...
	<div class="pagebx_3cols <?php if($n % 3 == 0) { echo "last_column"; } ?>">                                       
		...
		<?php //the_excerpt(); ?>	
        <a class="pagereadmore" href="<?php the_permalink(); ?>"><?php esc_html_e('Go','music-club-lite'); ?></a>	                        
		</div>                                   
	</div>
	<?php endwhile;
	wp_reset_postdata();                                  
